 ...
 * it is used solely to convert a list of text into a map of semantic descriptors.
 * It extends the SemanticDescriptors class to provide a convenient way to create instances of it.
 * 
...
public class SemanticDescriptorBuilder extends SemanticDescriptors {
     ...
     * 
     * @param textArrayList the list of sentences to be converted into a map of semantic descriptors
     ...
     */
    private static void calculateCoOccurance(HashMap<String, HashMap<String, Integer>> map, ArrayList<String> sentence, String word) {
